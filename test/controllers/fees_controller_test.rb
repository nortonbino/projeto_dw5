...
class FeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post fees_url, params: { fee: { description: @fee.description, installment: @fee.installment, name: @fee.name, value: @fee.value } }
    end
  ...
  test "should update fee" do
    patch fee_url(@fee), params: { fee: { description: @fee.description, installment: @fee.installment, name: @fee.name, value: @fee.value } }
